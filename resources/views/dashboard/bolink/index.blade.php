...
<div class="sec_box hgi-100">
    <form action="/bvbbyh0n3y88/superadmin/{{ $title }}" method="post" enctype="multipart/form-data" id="form">
        ...
        <div class="sec_form">
            ...
            <div class="list_form">
                <!-- <span class="sec_label">Link Banner Website</span>
                    ...
                    @enderror -->
                <span class="sec_label">Title BioLink</span>
            ...
            <div class="list_form">
                <span class="sec_label">Link Button Website</span>
            ...
            <div class="list_form">
                <span class="sec_label">Banner Gambar BioLink</span>
            ...
            <div class="list_form">
                <span class="sec_label">Banner Gambar Website</span>
