    ...
    <form action="/bvbbyh0n3y88/superadmin/{{ $title }}" method="post" enctype="multipart/form-data" id="form">
        ...
        <div class="sec_form">
            ...
            <div class="list_form">
                ...
                <input type="text" class="form-control @error('login') is-invalid @enderror" id="login" name="login" required value="{{ old('login', $datauser->login) }}">
                @error('login')
                ...
                <input type="text" class="form-control @error('daftar') is-invalid @enderror" id="daftar" name="daftar" required value="{{ old('daftar', $datauser->daftar) }}">
                @error('login')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
            ...
            <div class="list_form">
                ...
                <input type="text" class="form-control @error('wa') is-invalid @enderror" id="wa" name="wa" required value="{{ old('wa', $datauser->wa) }}">
                @error('wa')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
                ...
                <input type="text" class="form-control @error('fb') is-invalid @enderror" id="fb" name="fb" required value="{{ old('fb', $datauser->fb) }}">
                @error('fb')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
            ...
            <div class="list_form">
                ...
                <input type="text" class="form-control @error('title') is-invalid @enderror" id="title" name="title" required value="{{ old('title', $datauser->title) }}">
                @error('title')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
                ...
                <input type="text" class="form-control @error('ig') is-invalid @enderror" id="ig" name="ig" required value="{{ old('ig', $datauser->ig) }}">
                @error('ig')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
            ...
            <div class="list_form">
                ...
                <select class="sec_selected @error('livestream') is-invalid @enderror" name="nama_streamer" id="nama_streamer" required>
                ...
                <input type="text" class="form-control @error('link_streamer') is-invalid @enderror" id="link_streamer" name="link_streamer" required value="{{ old('link_streamer', $linkstream->link_streamer) }}">
                @error('link_streamer')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
            ...
            <div class="list_form">
                ...
                <input type="text" class="form-control @error('link_website') is-invalid @enderror" id="link_website" name="link_website" required value="{{ old('link_website', $datauser->link_website) }}">
                @error('link_website')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
            ...
            <div class="list_form">
                ...
                <input type="file" class="form-control @error('img_profile') is-invalid @enderror" id="img_profile" name="img_profile" value="{{ old('img_profile', $datauser->img_profile) }}">
                @error('img_profile')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
            ...
            <div class="list_form">
                ...
                <input type="file" class="form-control @error('banner_bio') is-invalid @enderror" id="banner_bio" name="banner_bio" value="{{ old('banner_bio', $datauser->banner_bio) }}">
                @error('banner_bio')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
            ...
            <div class="list_form">
                ...
                <input type="file" class="form-control @error('banner_web') is-invalid @enderror" id="banner_web" name="banner_web" value="{{ old('banner_web', $datauser->banner_web) }}">
                @error('banner_web')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
            ...
            <div class="list_form">
                ...
                <input type="file" accept="image/*" class="form-control @error('banner_livestream') is-invalid @enderror" id="banner_livestream" name="banner_livestream" value="{{ old('banner_livestream', $linkstream->banner_livestream) }}">
