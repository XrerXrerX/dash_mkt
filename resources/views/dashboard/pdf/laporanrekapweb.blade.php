    ...
    <table border="1">
        <thead>
            <tr>
                ...
                <th class="align-center">RTP</th>
                <th class="align-center">BUKTI JP</th>
                <th class="align-center">LIVECHAT</th>
            </tr>
        </thead>
        <tbody>
            @php
            ...
            @foreach ($data as $index => $d)
                <tr>
                    ...
                    <td class="align-center">{{ $d->rtp }}</td>
                    <td class="align-center">{{ $d->bukti_jp }}</td>
                ...
                @php
                    ...
                    $totalrtp += $d->rtp;
                    $totalbuktijp += $d->bukti_jp;
                    $totallivechat += $d->livechat;
            ...
            <tr class="total-row">
                ...
                <td class="col-casbon align-center black-text">{{ number_format($totalrtp, 0, ',', '.') }}</td>
                <td class="col-casbon align-center black-text">{{ number_format($totalbuktijp, 0, ',', '.') }}</td>
                <td class="col-casbon align-center black-text">{{ number_format($totallivechat, 0, ',', '.') }}</td>
            </tr>
        </tbody>
    </table>
</body>
